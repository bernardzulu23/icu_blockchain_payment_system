    ...
    >
      ...
      <div className="w-full max-w-lg relative z-10 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-8 shadow-2xl">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div>
            <input
              ...
              type="text"
              className="w-full bg-transparent border-b border-white/30 text-white py-3 placeholder:text-white/50 focus:outline-none focus:border-white transition-colors"
              placeholder="Batch Number / Reference (From your deposit slip)"
            />
          </div>
          <button 
            type="submit" 
        ...
        {query && (
          <div className="mt-8 pt-8 border-t border-white/10">
            {isLoading ? (
              ...
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 shadow-xl animate-in fade-in zoom-in duration-300">
                ...
                <div className="space-y-2 pl-11">
                  ...
                  <p className="text-2xl font-bold text-cyan-400">
                    {data.amount.toLocaleString()} ZMW
                  </p>
                  <div className="pt-2">
              ...
              <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-xl animate-in fade-in slide-in-from-top-2 duration-300">
                ...
                <div className="pl-11">
                  <p className="text-sm text-white/60 leading-relaxed">
                    Verify your Student ID and Reference. If you paid recently, allow 24-48 hours for processing.
                  </p>
                </div>
              </div>
            )}
        ...
        <div className="mt-8 text-center">
          <a href="/login" className="text-white/60 hover:text-white font-bold text-xs uppercase tracking-widest transition-all">
            Staff login
          </a>
        </div>
      </div>
